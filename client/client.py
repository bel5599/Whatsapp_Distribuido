...
def replication_user(inf_nodo,nickname,password):
    ...
    return dict_successor,dict_predecessor

def replication_messenge(inf_nodo,user,messenge):
    pass
...
def register(nickname: str, password: str, server: str):
    ...
    dict_successor,dict_predecessor = replication_user(node_data,nickname,password)
...
def send(user: str, message: str):
    ...
    # FALTA VERIFICACION DE SI ESTA ACTIVO O NO UN SERVIDOR 
