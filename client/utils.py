...
def replication_user(inf_nodo:dict,nickname:str,password:str,ip:str,port:str):
    try:
        ...
        server_node_data.add_user(nickname,password,ip,port,True)
    except:
        return False,False    
    try:
        ...
        server_successor.add_user(nickname,password,ip,port,False)
        ...
        server_successor_successor.add_user(nickname,password,ip,port,False)
    except:
        return False,False
